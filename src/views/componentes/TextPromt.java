 ...
 *  class construction.
 */
public class TextPromt extends JLabel
	implements FocusListener, DocumentListener
{
	...
	public TextPromt(String text, JTextComponent component)
	{
		this(text, component, Show.ALWAYS);
	}

	public TextPromt(String text, JTextComponent component, Show show)
	{
